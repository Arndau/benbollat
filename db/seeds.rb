...
user3= User.create!(surnom: "test_user", email: "test@gmail.com", password: "123456")
user1= User.create!(surnom: "Johny_be_good", email: "meli@gmail.com", password: "123456")
user2= User.create!(surnom: "Cindy Loper", email: "arnaud@gmail.com", password: "123456", admin: true)
user4= User.create!(surnom: "Mr patate", email: "mrpatate@gmail.com", password: "123456", super_admin: true)
