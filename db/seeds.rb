...
user1= User.create!(surnom: "Johny_be_good", email: "meli@gmail.com", password: "123456", avatar: "Photo4.jpg")
user2= User.create!(surnom: "Cindy Loper", email: "arnaud@gmail.com", password: "123456", avatar: "WBKeG.jpeg")
